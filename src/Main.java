...
public class Main {
    public static void main(String[] args) {
        ...
        newSubTask1 = new SubTask(6, "Фундамент", "Залить фундамент", Status.IN_PROGRESS, 4);
        manager.updateSubTask(newSubTask1);
        manager.getEpicById(4);
        System.out.println(manager.getSubTAsksByEpicId(4));

        System.out.println();
        System.out.println("$$$$$$$$$$Тест 8 - Завершаем подзадачу 2 эпика и сам Эпик:");
        newSubTask2 = new SubTask(8, "Выбор курсов", "Выбрать подходящие курсы", Status.DONE, 5);
        manager.updateSubTask(newSubTask2);
        manager.getEpicById(5);
        System.out.println(manager.getSubTAsksByEpicId(5));

        System.out.println();
        System.out.println("$$$$$$$$$$Тест 9 - Добавление новой подзадачи в завершенный эпик");
        newSubTask2 = new SubTask("Оплата курсов", "Оплатить выбранные курсы", 5);
        manager.createSubTask(newSubTask2);
        manager.getEpicById(5);
        System.out.println(manager.getSubTAsksByEpicId(5));
